...
export const BANGLA_VOICES: BanglaVoicePersona[] = [
  {
    ...
    roleBn: 'AI Customer Care Specialist',
    gender: 'female',
    avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=300&auto=format&fit=crop&q=80',
    descBn: 'Polite & welcoming female voice — Customer support & lead generation',
    pitch: 1.0,
    rate: 0.95,
  },
  {
    ...
    roleBn: 'AI Sales & E-commerce Executive',
    gender: 'female',
  ...
  },
  {
    ...
    roleBn: 'AI Enterprise Consultant',
    gender: 'male',
